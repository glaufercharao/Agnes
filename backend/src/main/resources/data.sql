...
INSERT INTO task (title, description, status, initial_date, activity_id) VALUES ('Criar CRUD CLIENTE','Criar CRUD para cliente no backend', 1, now(), 1);
INSERT INTO task (title, description, status, initial_date, activity_id) VALUES ('Criar CRUD Produtos','Criar CRUD para produtos no Frontend', 1, now(), 4);
INSERT INTO task (title, description, status, initial_date, activity_id) VALUES ('Criar CRUD CLIENTE','Criar CRUD para cliente no Frontend', 1, now(), 1);